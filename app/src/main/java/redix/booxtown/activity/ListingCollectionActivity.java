...
public class ListingCollectionActivity extends Fragment implements LocationListener,OnMapReadyCallback,GoogleMap.OnMapLongClickListener, GoogleMap.OnInfoWindowClickListener  {
...
//        TextView title_menu = (TextView)v.findViewById(R.id.txt_title);
